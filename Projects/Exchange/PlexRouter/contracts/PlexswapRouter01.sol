...
contract PlexswapRouter01 is IPlexswapRouter01 {
    ...
    function swapExactTokensForTokens(
        ...
        TransferHelper.safeTransferFrom(path[0], msg.sender, PlexswapLibrary.pairFor(factory, path[0], path[1]), amounts[0]);
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) public pure override returns (uint amountIn) {
        return PlexswapLibrary.getAmountOut(amountOut, reserveIn, reserveOut);
    }
