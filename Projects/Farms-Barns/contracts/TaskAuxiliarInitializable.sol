...
contract TaskAuxiliarInitializable is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20Metadata;

    // The address of the smart chef factory
    address public TASK_AUXILIAR_FACTORY;
    ...
    constructor() {
        TASK_AUXILIAR_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == TASK_AUXILIAR_FACTORY, "Not factory");
